        ...
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="">Categories</a>
            <ul>
              ...
              {
              ?>
              <li>  <a href="<?php echo $id?>"><?php echo $row['Name']; ?></a></li>
              <?php
              }
              ?>
            </ul>
          ...
          <li><a href="#portfolio">Sign In</a></li>
    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          $id = $_GET['category'];
          $select = "SELECT * FROM `products` WHERE `CategoryId` = $id ";
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
            <div class="portfolio-wrap">
              <figure>
                ...
                <a href="<?php echo $row['ImagePath']; ?>" data-lightbox="portfolio" data-title="App 1" class="link-preview" title="Preview"><i class="ion ion-eye"></i></a>
                <a href="#" class="link-details" title="More Details"><i class="ion ion-android-open"></i></a>
              </figure>
              <div class="portfolio-info">
                <h4><a href="<?php echo $row['Id']; ?>">Name</a></h4>
